...
export default function Home() {
  ...
  const Crescent = () => {
    return (
      <Link
        href={"/knowmore"}
        className="bg-BeautyLightYellow flex flex-row items-center justify-center font-LotaSemiBold cursor-pointer rounded-tl-[69px] rounded-tr-[69px] rounded-br-[0px] rounded-bl-[69px] md:rounded-tl-[126px] md:rounded-tr-[126px] md:rounded-br-[0px] md:rounded-bl-[126px]  lg:rounded-tl-[126px] lg:rounded-tr-[126px] lg:rounded-br-[0px] lg:rounded-bl-[126px] xl:rounded-tl-[126px] xl:rounded-tr-[126px] xl:rounded-br-[0px] xl:rounded-bl-[126px]  w-[140px] md:w-[269px] lg:w-[269px] xl:w-[269px] h-[130px] md:h-[252px] lg:h-[252px] xl:h-[252px] absolute knowmorej left-0 md:left-0 lg:left-[105px] xl:left-[110px] mt-5 md:mt-[-75px] lg:mt-[-100px] xl:mt-[-100px]"
      >
        <p className="font-LotaSemiBold font-semibold text-base md:text-xl lg:text-2xl xl:text-2xl leading-8 text-black">
          Know More
        </p>
  ...
  const Biscuit = () => {
    return (
      <Link
        href="/about"
        className="bg-BeautyLightBrown flex flex-row items-center justify-center font-LotaSemiBold cursor-pointer rounded-[32px] md:rounded-[32px] lg:rounded-[58px] xl:rounded-[58px] w-[104px] md:w-[104px] lg:w-[188px] xl:w-[188px] h-[170px] md:h-[170px] lg:h-[275px] xl:h-[275px] rotate-90 md:rotate-90 lg:rotate-0 xl:rotate-90 absolute bottom-0 right-[19px] md:right-[150px] lg:right-0 xl:right-0 top-[12px] md:top-full lg:top-full xl:top-full mt-0 md:mt-[-39px] lg:mt-12 xl:mt-12 z-50"
      >
