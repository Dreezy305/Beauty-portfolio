...
function TopUnista(): JSX.Element {
  return (
    <>
      <div className="hidden md:block lg:block xl:block rounded-tl-[30px] rounded-tr-[30px] rounded-br-none rounded-bl-none py-6 px-7 h-60 w-full bg-BeautyUnista mt-10 unista-image-background">
