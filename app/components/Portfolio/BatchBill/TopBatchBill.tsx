...
function TopBatchBill(): JSX.Element {
  ...
  return (
    ...
    <div className="hidden md:hidden lg:block xl:block  rounded-tl-[30px] rounded-tr-[30px] rounded-br-none rounded-bl-none py-6 px-5 md:px-6 lg:px-7 xl:px-7 w-full bg-BeautyDeepBlue mt-10 batchbill-image-background h-72">
      <div className="w-full md:w-4/5 lg:w-1/2 xl:w-1/2 flex flex-col space-y-5 pt-5">
        <Image
          src={BatchBill}
          alt="layer"
